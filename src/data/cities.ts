...
export const citiesWithCountries: CityWithCountry[] = [
  ...
  { city: 'Грозный', country: 'Russia', cityEn: 'Grozny' },
  ...
  { city: 'Урус-Мартан', country: 'Russia', cityEn: 'Urus-Martan' },
  { city: 'Аргун', country: 'Russia', cityEn: 'Argun' },
  { city: 'Гудермес', country: 'Russia', cityEn: 'Gudermes' },
  { city: 'Катыр-Юрт', country: 'Russia', cityEn: 'Katyr-Yurt' },
  ...
  { city: 'Ведучи', country: 'Russia', cityEn: 'Veduchi' },
  { city: 'Шали', country: 'Russia', cityEn: 'Shali' },
  { city: 'Ачхой-Мартан', country: 'Russia', cityEn: 'Achkhoy-Martan' },
  { city: 'Курчалой', country: 'Russia', cityEn: 'Kurchaloy' },
  { city: 'Наурская', country: 'Russia', cityEn: 'Naurskaya' },
  { city: 'Ойсхара', country: 'Russia', cityEn: 'Oiskhara' },
  { city: 'Серноводское', country: 'Russia', cityEn: 'Sernovodskoye' },
  ...
  { city: 'Шалажи', country: 'Russia', cityEn: 'Shalazhi' },
