...
export const citiesWithCountries: CityWithCountry[] = [
  ...
  { city: 'Пятигорск', country: 'Russland', cityEn: 'Pyatigorsk' },
  { city: 'Урус-Мартан', country: 'Russland', cityEn: 'Urus-Martan' },
  { city: 'Аргун', country: 'Russland', cityEn: 'Argun' },
  { city: 'Гудермес', country: 'Russland', cityEn: 'Gudermes' },
  { city: 'Катыр-Юрт', country: 'Russland', cityEn: 'Katyr-Yurt' },
  { city: 'Магас', country: 'Russland', cityEn: 'Magas' },
  { city: 'Назрань', country: 'Russland', cityEn: 'Nazran' },
  { city: 'Домбай', country: 'Russland', cityEn: 'Dombay' },
  { city: 'Ессентуки', country: 'Russland', cityEn: 'Essentuki' },
  { city: 'Минеральные Воды', country: 'Russland', cityEn: 'Mineralnye Vody' },
  { city: 'Кисловодск', country: 'Russland', cityEn: 'Kislovodsk' },
  { city: 'Ведучи', country: 'Russland', cityEn: 'Veduchi' },
  { city: 'Шали', country: 'Russland', cityEn: 'Shali' },
  { city: 'Ачхой-Мартан', country: 'Russland', cityEn: 'Achkhoy-Martan' },
  { city: 'Курчалой', country: 'Russland', cityEn: 'Kurchaloy' },
  { city: 'Наурская', country: 'Russland', cityEn: 'Naurskaya' },
  { city: 'Ойсхара', country: 'Russland', cityEn: 'Oiskhara' },
  { city: 'Серноводское', country: 'Russland', cityEn: 'Sernovodskoye' },
  { city: 'Избербаш', country: 'Russland', cityEn: 'Izberbash' },
  { city: 'Кизляр', country: 'Russland', cityEn: 'Kizlyar' },
  { city: 'Прохладный', country: 'Russland', cityEn: 'Prokhladny' },
  { city: 'Сочи', country: 'Russland', cityEn: 'Sochi' },
  { city: 'Геленджик', country: 'Russland', cityEn: 'Gelendzhik' },
  { city: 'Буденновск', country: 'Russland', cityEn: 'Budyonnovsk' },
  { city: 'Шахты', country: 'Russland', cityEn: 'Shakhty' },
  { city: 'Ейск', country: 'Russland', cityEn: 'Yeysk' },
  { city: 'Волгодонск', country: 'Russland', cityEn: 'Volgodonsk' },
  { city: 'Лиски', country: 'Russland', cityEn: 'Liski' },
  { city: 'Липецк', country: 'Russland', cityEn: 'Lipetsk' },
  { city: 'Тамбов', country: 'Russland', cityEn: 'Tambov' },
  { city: 'Старый Оскол', country: 'Russland', cityEn: 'Stary Oskol' },
  { city: 'Тула', country: 'Russland', cityEn: 'Tula' },
  { city: 'Курск', country: 'Russland', cityEn: 'Kursk' },
  { city: 'Брянск', country: 'Russland', cityEn: 'Bryansk' },
  { city: 'Орёл', country: 'Russland', cityEn: 'Oryol' },
  { city: 'Калуга', country: 'Russland', cityEn: 'Kaluga' },
  { city: 'Смоленск', country: 'Russland', cityEn: 'Smolensk' },
  ...
  // Jordan
  { city: 'Аммон', country: 'Jordanien', cityEn: 'Amman' },
  { city: 'Сувейлех', country: 'Jordanien', cityEn: 'Suweileh' },
  { city: 'Эз-Зарка', country: 'Jordanien', cityEn: 'Zarqa' },
  ...
  { city: 'Kahramanmaraş', country: 'Türkei', cityRu: 'Кахраманмараш', cityEn: 'Kahramanmaras' },
  { city: 'Kars', country: 'Türkei', cityRu: 'Карс', cityEn: 'Kars' },
  { city: 'Sivas', country: 'Türkei', cityRu: 'Сивас', cityEn: 'Sivas' },
  { city: 'Mardin', country: 'Türkei', cityRu: 'Мардин', cityEn: 'Mardin' },
