    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fadeIn">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6 animate-scaleIn">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              ...
              <input
                ...
                id="register-email"
                name="email"
                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-moonlit-500 focus:border-transparent"
            ...
            <div className="flex items-start space-x-2">
              <input
                ...
                className="mt-1 h-4 w-4 text-moonlit-600 focus:ring-moonlit-500 border-gray-300 rounded"
                required
                disabled={emailSent}
              />
              <label htmlFor="accept-terms" className="text-sm text-gray-700">
                ...
                <button
                  ...
                  className="text-moonlit-600 hover:text-moonlit-800 underline"
                >
                  Nutzungsbedingungen
                </button>
              </label>
            ...
            <button
              type="submit"
              className="w-full bg-moonlit-600 text-white py-3 rounded-lg hover:bg-moonlit-700 transition duration-200"
              disabled={emailSent}
            >
        ...
        <div className="mt-6 text-center">
          <button
            onClick={toggleMode}
            className="text-moonlit-600 hover:text-moonlit-800 transition duration-200"
          >
