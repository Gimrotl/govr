                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-2 gap-3 mt-4">
                            ...
                            <div className="bg-green-50 rounded-lg p-3">
                              ...
                              <p className="text-lg font-bold text-emerald-600">{ride.price}</p>
                            </div>
                          </div>
                        </div>
                      ...
                      {order.status === 'pending' && (
                        <div className="flex space-x-3">
                          <button
                            ...
                            className="flex-1 flex items-center justify-center bg-emerald-500 text-white py-3 px-4 rounded-xl font-semibold hover:bg-emerald-600 transition-all duration-200 shadow-md hover:shadow-lg"
                          >
