...
const getTypeIcon = (type: string) => {
  switch (type) {
    case 'Raststätte':
      return <Car size={16} className="text-moonlit-600" />;
    case 'Hotel':
...
const getAmenityIcon = (amenity: string) => {
  switch (amenity) {
    ...
    case 'Grün':
      return <div className="bg-moonlit-100 text-moonlit-800 px-1.5 md:px-2 py-0.5 md:py-1 rounded-full text-xs flex items-center">
      ...
      <div className="flex items-start justify-between mb-10">
        ...
        {isAdmin && (
          <button
            ...
            className="ml-4 bg-moonlit-600 text-white p-3 rounded-full hover:bg-moonlit-700 transition duration-200 flex-shrink-0"
