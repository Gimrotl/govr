    ...
    <section className="my-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {cards.map((card, index) => (
          <div
            key={card.id}
            className={`card-fold bg-gray-100 rounded-lg p-6 transition-all duration-300 hover:bg-white hover:shadow-lg hover:-translate-y-1 cursor-pointer group border-t-2 ${borderColors[index % borderColors.length]} border border-gray-200 hover:border-gray-300`}
          >
