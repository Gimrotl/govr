...
import { ChevronRight, ChevronLeft, Car, Luggage, Users } from 'lucide-react';
import { useInfoCards } from '../hooks/useInfoCards';
import { useModals } from '../hooks/useModals';
import { InfoCardData } from '../contexts/ModalsContext';

const iconComponents = [Car, Luggage, Users];
...
const iconTypes: Array<'car' | 'luggage' | 'users'> = ['car', 'luggage', 'users'];
